// components/show/ShowBookingFlow.jsx
"use client";
...
export default function ShowBookingFlow() {
  ...
  const steps = [
    ...
    { id: 2, title: 'Choose Places', subtitle: 'Reserve spots', icon: Users },
    { id: 3, title: 'Your Details', subtitle: 'Personal info', icon: UserCheck },
    { id: 4, title: 'Payment', subtitle: 'Complete booking', icon: CreditCard }
  ];

  const canProceedToNext = () => {
    const { selectedDate, selectedSeats, isUserDetailsValid } = useUserShowBookingStore.getState();
    
    switch(currentStep) {
      case 1: return !!selectedDate;
      case 2: return selectedSeats.length > 0;
      case 3: return isUserDetailsValid;
      case 4: return true;
  ...
  const renderStepContent = () => {
    switch(currentStep) {
      case 1: return <ShowDateSelection />;
      case 2: return <ShowSeatSelection />;
      case 3: return <ShowUserDetails />;
      case 4: return <ShowPaymentProcess onBack={() => prevStep()} />;
      default: return null;
    }
  };
