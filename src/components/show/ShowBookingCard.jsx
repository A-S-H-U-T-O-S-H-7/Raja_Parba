    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          ...
          <span className="inline-flex items-center rounded-md border border-purple-200 bg-gradient-to-r from-purple-50 to-indigo-50 px-2.5 py-1 font-mono text-xs sm:text-sm font-semibold text-purple-700">
