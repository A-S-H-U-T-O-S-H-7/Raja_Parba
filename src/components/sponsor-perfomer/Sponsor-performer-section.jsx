  ...
  return (
    <div className="relative  bg-gradient-to-br from-teal-200 via-white to-teal-200   rounded-2xl overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 -right-4 w-52 h-52 bg-yellow-300 rounded-full   animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-20 w-42 h-42 bg-pink-300 rounded-full   animate-blob animation-delay-4000"></div>
      </div>
