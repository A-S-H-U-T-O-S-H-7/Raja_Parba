// components/admin/admins/AdminModals/EditAdminModal.jsx
"use client";
...
export default function EditAdminModal({ isOpen, onClose, onSuccess }) {
  const { isDarkMode } = useThemeStore();
  const { selectedAdmin, updateAdmin, clearSelectedAdmin } = useAdminManagementStore();
      ...
      <div className={`relative w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-xl shadow-2xl ${
        ...
        <div className={`px-6 py-3 bg-blue-50 dark:bg-blue-900/20 border-b ${
          ...
          <p className={`text-sm flex items-center gap-2 ${
            ...
            Editing: {selectedAdmin.email} (Username: {selectedAdmin.username})
          </p>
        </div>
