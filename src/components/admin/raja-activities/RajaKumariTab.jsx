                ...
                return (
                  <tr key={item.id} className={isDarkMode ? 'hover:bg-gray-800/80' : 'hover:bg-slate-50'}>
                    <td className="px-5 py-4">
                      <div className="h-16 w-16 overflow-hidden rounded-lg border border-pink-200 bg-slate-100">
                        {item.photoUrl ? (
                    ...
                    <td className="px-5 py-4">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-slate-600'}`}>Raja Kumari</p>
      ...
      {editingItem && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/50 p-4">
          <div className={`w-full max-w-lg rounded-2xl border p-6 shadow-2xl ${isDarkMode ? 'border-gray-700 bg-gray-900' : 'border-slate-200 bg-white'}`}>
            <h3 className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>Update Raja Kumari Status</h3>
